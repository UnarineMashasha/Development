...
(function ($) {
  ...
  function load_owl() {
    ...
    jQuery("#ceo-desk-carousel").owlCarousel({
      items: 3,
      navigation: false,
      pagination: true,
    });
    ...
    jQuery(".ceo-desk-slide").owlCarousel({
      items: 1,
      singleItem: true,
      navigation: false,
      pagination: false,
    ...
    $(".next").on("click", function () {
      $(this).parent().parent().find(".ceo-desk-slide").trigger("owl.next");
    });
    $(".prev").on("click", function () {
      $(this).parent().parent().find(".ceo-desk-slide").trigger("owl.prev");
    });
  ...
  jQuery(document).ready(function () {
    ...
    // ceo-desk list hover
    // --------------------------------------------------
    jQuery(".ceo-desk-list")
      .on("mouseenter", function () {
        var v_height = jQuery(this).find(".ceo-desk-slide").css("height");
        var v_width = jQuery(this).find(".ceo-desk-slide").css("width");
